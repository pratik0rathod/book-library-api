...
async def count_all_books(
    ...
    return functions.count_books(db=db, user=user)
...
async def get_all_books(
    ...
    return functions.get_all_books(db=db, user=user)
...
async def get_a_book(
    ...
    return functions.get_a_book(db=db, user=user, book_id=book_id)
...
async def search_book(
    ...
    return functions.search_book(db, user=user, search=search)
...
async def create_book_item(
    ...
    return functions.create_book_item(db, user=user, book=book)
...
async def edit_book_item(
    ...
    return functions.edit_book_item(db, user=user, book_id=book_id, book=book)
...
async def delete_book_item(
    ...
    return functions.delete_book_item(db, user=user, book_id=book_id)
